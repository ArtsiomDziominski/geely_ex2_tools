...
object VhalConstants {
    ...
    const val ENERGY_REGENERATION_LEVEL_LOW = 0x22020501
    const val ENERGY_REGENERATION_LEVEL_MID = 0x22020502
    const val ENERGY_REGENERATION_LEVEL_HIGH = 0x22020503
